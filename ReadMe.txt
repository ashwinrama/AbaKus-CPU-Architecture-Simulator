...
Source Code: (Compiled using gcc)
full_main.cc -> Main pipeline structure; Contains the function calls of the pipeline architecture
sys-abakus*.cc -> architecture definition of the functional units.
